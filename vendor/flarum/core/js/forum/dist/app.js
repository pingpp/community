...
System.register('flarum/components/Search', ['flarum/Component', 'flarum/components/LoadingIndicator', 'flarum/utils/ItemList', 'flarum/utils/classList', 'flarum/utils/extractText', 'flarum/helpers/icon', 'flarum/components/DiscussionsSearchSource', 'flarum/components/UsersSearchSource', 'flarum/components/SearchEngineSource'], function (_export, _context) {
  ...
  return {
    ...
    }, function (_flarumComponentsSearchEngineSource) {
      SearchEngineSource = _flarumComponentsSearchEngineSource.default;
    }],
    execute: function () {
...
System.register('flarum/components/SearchEngineSource', ['flarum/helpers/highlight', 'flarum/components/LinkButton'], function (_export, _context) {
    "use strict";

    var highlight, LinkButton, SearchEngineSource;
    return {
        setters: [function (_flarumHelpersHighlight) {
            highlight = _flarumHelpersHighlight.default;
        }, function (_flarumComponentsLinkButton) {
        ...
        execute: function () {
            SearchEngineSource = function () {
                function SearchEngineSource() {
                    babelHelpers.classCallCheck(this, SearchEngineSource);

                    this.results = {};
                }

                babelHelpers.createClass(SearchEngineSource, [{
                    key: 'search',
                    value: function search(query) {
            ...
            _export('default', SearchEngineSource);
        }
    };
});;
"use strict";
